...
const esModuleResult = cp.execSync(`${process.cwd()}/bin/eater.js --reporter ${process.cwd()}/test/reporter/EsModuleReporter  --dir test/fixture/ --ext success.js`).toString();
